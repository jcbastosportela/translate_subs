...
logger = logging.getLogger(utils.logger_id)
logger.propagate = False

# noinspection PyBroadException
try:
    handler_name = utils.addon_info.addon.getSettingString('log-handler').lower()
except:
    handler_name = 'kodi'
...
# noinspection PyBroadException
try:
    log_lvl_idx = utils.addon_info.addon.getSettingInt('log-level')
